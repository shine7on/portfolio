...
import { BsArrowRight, BsArrowThroughHeart } from "react-icons/bs";
...
const Hero = () => {
    return <div className="relative h-screen flex items-center justify-center text-white overflow-hidden flex-col">
        ...
        {/* Large screens → Clouds */}
        <div className="absolute inset-0 z-0 hidden lg:block">
        <VantaCloudsBackground />
        </div>
        <div className="relative z-10 flex flex-col items-center">
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl mt-6 text-center font-bold tracking-wide">
                Hi, I'm {" "}
